...
export function StoreStats({ onBack }: Props) {
  ...
  return <div className="app-shell"><header className="page-header"><button className="back-button" type="button" onClick={onBack}>‹</button><div><p className="app-eyebrow">STORE RESULTS</p><h1>店舗戦績</h1></div></header><main className="store-main">
